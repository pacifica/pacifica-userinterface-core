...
function pacifica_install_tasks() {
  ...
  $tasks['pacifica_prepare_administrator'] = [];
  $tasks['pacifica_set_front_page'] = [];
  $tasks['pacifica_disallow_free_registration'] = [];
  $tasks['pacifica_grant_shortcut_access'] = [];
  $tasks['pacifica_set_default_theme'] = [];
  $tasks['pacifica_set_logo'] = [];
  $tasks['pacifica_alter_frontpage_view'] = [];
 ...
 */
function pacifica_prepare_administrator() {
 ...
 */
function pacifica_set_front_page() {
 ...
 */
function pacifica_disallow_free_registration() {
  Drupal::configFactory()
 ...
 */
function pacifica_grant_shortcut_access() {
 ...
 */
function pacifica_set_default_theme() {
  Drupal::configFactory()
...
/**
 * Set the path to the logo based on install directory.
 */
 ...
 */
function pacifica_alter_frontpage_view() {
        ...
        'display_options' => [
          ...
          'empty' => [
            'area_text_custom' => [
              ...
              'empty' => TRUE,
              'tokenize' => TRUE,
              'content' => '<p>Welcome to [site:name]. No front page content has been created yet.</p><p>Would you like to <a href="' . drupal_get_path('profile', 'pacifica') . '/README.md">view the README</a>?</p>',
              'label' => '',
 ...
 */
function pacifica_modules_installed(array $modules) {
 ...
 */
function pacifica_user_role_presave(RoleInterface $role) {
